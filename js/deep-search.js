...
(function () {
  ...
  var PILLS = [
    { label: 'Tellera People', seed: "What's known about Martin R. Decker in Austin, TX?", icon: '<img class="ds-pill__img" src="/assets/pills/people.png" alt="">' },
    { label: 'Tellera Phone', seed: 'Who owns (512) 555-0142?', icon: '<img class="ds-pill__img" src="/assets/pills/phone.png" alt="">' },
    { label: 'Tellera Email', seed: 'Who is behind mail@domain.com?', icon: '<img class="ds-pill__img" src="/assets/pills/email.png" alt="">' },
    { label: 'Tellera Property', seed: 'Who owns 1234 Oakridge Dr, Austin TX?', icon: '<img class="ds-pill__img" src="/assets/pills/property.png" alt="">' },
    { label: 'Tellera Vehicle', seed: 'Is VIN 1FTFW1E5… clean?', icon: '<img class="ds-pill__img" src="/assets/pills/vehicle.png" alt="">' }
  ];
